        ...
        <div className="filter-wrapper">
          ...
          <div className="filter-group">
            ...
            <div className="f-options">
              ...
              <button className={selectedBrand === 'matli' ? 'active' : ''} onClick={() => setSelectedBrand('matli')}>Matlı</button>
              <button className={selectedBrand === 'cp' ? 'active' : ''} onClick={() => setSelectedBrand('cp')}>CP Yem</button>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="yem-product-list container">
        <div className="section-title">
          <h2>
            ...
            {selectedCategory === 'all' ? 'Tüm Ürünlerimiz' : (selectedCategory === 'buyukbas' ? 'Büyükbaş Yemleri' : (selectedCategory === 'kucukbas' ? 'Küçükbaş Yemleri' : 'Kanatlı Yemleri'))}
          </h2>
